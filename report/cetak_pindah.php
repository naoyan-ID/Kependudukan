...
<body>
	...
	<center>
		...
		<h4>
			No Surat : <?php echo $data['id_pend']; ?>/Ket.Pindah/04/04/<?php echo $tanggal; ?>
		</h4>
	</center>
	...
	<p>Benar-benar telah <b>pindah</b> dari wilayah RT004 Kelurahan Jagakarsa, Kecamatan Jagakarsa, Jakarta Selatan.</P>
