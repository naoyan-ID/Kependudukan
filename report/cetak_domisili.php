...
<body>
	...
	<center>
		...
		<h4>
			No Surat : <?php echo $data['id_pend']; ?>/Ket.Domisili/04/04/<?php echo $tanggal; ?>
		</h4>
	</center>
	...
	<p>Adalah benar-benar warga RT004, Kelurahan Jagakarsa, Kecamatan Jagakarsa, Jakarta Selatan.</P>
