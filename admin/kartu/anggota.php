...
<div class="card card-primary">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-users"></i> Anggota Kartu Keluarga</h3>
	</div>
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" value="<?php echo $data_cek['alamat']; ?>, RT <?php echo $data_cek['rt']; ?> RW <?php echo $data_cek['rw']; ?> Kelurahan <?php echo $data_cek['kel']; ?>, Kecamatan <?php echo $data_cek['kec']; ?>, <?php echo $data_cek['kota']; ?> <?php echo $data_cek['prov']; ?> <?php echo $data_cek['pos']; ?>"
					 readonly/>
				</div>
			</div>
			<div class="form-group row">
