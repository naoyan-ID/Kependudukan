	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="pos" name="pos" placeholder="Kode Pos" required>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="kab" name="kab" placeholder="Kota" required>
				</div>
			</div>
			<div class="form-group row">
...
<?php
    if (isset ($_POST['Simpan'])){
        $sql_simpan = "INSERT INTO tb_kk (no_kk, kepala, alamat, rt, rw, pos, kel, kec, kota, prov) VALUES (
            '".$_POST['no_kk']."',
            '".$_POST['kepala']."',
            '".$_POST['alamat']."',
            '".$_POST['rt']."',
